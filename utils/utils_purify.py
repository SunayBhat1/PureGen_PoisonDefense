    ...
    if args.poison_type == 'GradientMatching':
        ...
        if args.poison_mode == 'from_scratch':
            ...
            if args.dataset == 'stl10':
                ...
                poison_tuple_list, poison_indices, target = get_poisoned_subset_narcissus(os.path.join(args.data_dir,f'PoisonDefense/Poisons/Narcissus/{args.dataset}/size={args.noise_sz_narcissus}_eps={args.noise_eps_narcissus}_num={args.num_images_narcissus}/best_noise_lab{stl_cifar_label_map[target_index]}.npy'), 
                                                                                        args.data_dir, args.dataset, target_index, args.num_images_narcissus, not args.random_imgs_narcissus, index_list)
            else:
                poison_tuple_list, poison_indices, target = get_poisoned_subset_narcissus(os.path.join(args.data_dir,f'PoisonDefense/Poisons/Narcissus/{args.dataset}/size={args.noise_sz_narcissus}_eps={args.noise_eps_narcissus}_num={args.num_images_narcissus}/best_noise_lab{target_index}.npy'), 
                                                                                        args.data_dir, args.dataset, target_index, args.num_images_narcissus, not args.random_imgs_narcissus, index_list)
